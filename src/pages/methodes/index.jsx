            ...
            <div className="bg-white rounded-lg border p-4">
              ...
              <div className="px-1 py-4">
                ...
                <p className="text-gray-700 text-base">
                  ...
                  haarfollikels. Deze follikels worden vervolgens geïmplanteerd
                  in de kale of dunner wordende delen van het hoofd. FUT
                  resulteert vaak in een lineair litteken in het donorgebied en
                  een langere herstelperiode dan andere methoden.
                </p>
            ...
            <div className="bg-white rounded-lg border p-4">
              ...
              <div className="px-1 py-4">
                ...
                <p className="text-gray-700 text-base">
                  ...
                  vervaardigde saffierkristallen mesje in plaats van een metalen
                  instrument. Dit resulteert in minder trauma aan de hoofdhuid
            ...
            <div className="bg-white rounded-lg border p-4">
              ...
              <div className="px-1 py-4">
                ...
                <p className="text-gray-700 text-base">
                  ...
                  wordt gekoeld met ijs voordat de follikels worden geoogst. Dit
                  vermindert de kans op bloedingen en vermindert het ongemak
